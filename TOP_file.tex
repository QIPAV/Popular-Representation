...
\begin{titlepage}
    ...
    \begin{figure}[h]
        ...
        \\[2.0 cm] 
    \end{figure}                              
    \textsc{\Huge Popular Representation}  
    \\[1 cm]
...
0.0       & $08.01.17$   & Created Popular Representation & TL  & SF \\       & & Github Synced               &     & \\\rowcolor{gainsboro}
0.1       & $10.01.17$   & Added reference list  & SF    & Name          \\
...
% INTRODUCTION 
\subfile{Sections/PopularRepresentation}
\newpage 

% CHAPTER
%\subfile{Sections/relatedProjects}
%\newpage

% CHAPTER
%\subfile{Sections/functionalDescription}
%\newpage
